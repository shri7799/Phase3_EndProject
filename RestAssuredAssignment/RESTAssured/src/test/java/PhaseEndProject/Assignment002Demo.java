...
public class Assignment002Demo {
	...
	public void assignment002Post() {
		...
		File file = new File(
				"C:\\Users\\lenovo\\Desktop\\CoreJavaPracticeProgram\\Phase3RESTAPI\\RESTAssured\\src\\main\\resource\\data.json");
	...
	public void assignment002Put() {
		File file = new File(
				"C:\\Users\\lenovo\\Desktop\\CoreJavaPracticeProgram\\Phase3RESTAPI\\RESTAssured\\src\\main\\resource\\dataput.json");
		int id = RestAssured.given().baseUri("https://petstore.swagger.io/v2/pet/").contentType(ContentType.JSON)
