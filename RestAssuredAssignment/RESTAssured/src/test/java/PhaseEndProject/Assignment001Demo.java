...
public class Assignment001Demo {
	...
	public void Assignment001Post() {
		...
		File file = new File("C:\\Users\\lenovo\\Desktop\\CoreJavaPracticeProgram\\Phase3RESTAPI\\RESTAssured\\src\\main\\resource\\data.json");
	...
	public void assignment001Get() {
		...
		int id = RestAssured.given()
				.baseUri("https://petstore.swagger.io/v2/pet/2003")
				.when().get()
				.then().statusCode(200)
				.log().all()
